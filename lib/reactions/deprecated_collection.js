...
var CollectionReaction = Reaction.extend({
  ...
  reactIf: function(el) {
    return rules.deprecatedCollection(el);
  },

  parse: function(el, state) {
    var collectionName = rules.deprecatedCollection(el),
    ...
    children.each(function(i, element) {
      ...
      EndDash.templateStore.load(templateName, child);
      templates[whenValue] = EndDash.templateStore.getTemplateClass(templateName);
      child.remove();
    })
