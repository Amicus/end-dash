...
function CollectionFactory(name, selector, polymorphicKey, parentTemplate) {
  this.name = name
...
/** 
 * TODO this is a super hack until we move collections and
 * models into reactions and have order of operations.
 **/
CollectionFactory.prototype.mapReaction = function() {
  this.parentTemplate.mapReaction.apply(this.parentTemplate, arguments)
},
