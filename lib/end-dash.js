 ...
 *
 * markup - The markup from which to create the template
 * opts
 *   * parse - whether or not to parse the supplied markup right away
 *
 * @api public
 **/
 ...
 *
 * conf
 *   * viewDirectory - the directory where view files can be found using require()
 *
 * @api public
 **/
...
TemplateMethods.bind = function(data) {
  ...
  this.traverse(function(name, type, element) {
    ...
    if(type == "view" && config.viewDirectory) {
