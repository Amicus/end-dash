...
TemplateFactory.prototype.mapCollection = function(name, element, polymorphicKey) {
  ...
  return this.templateProto.collectionFactories[name] = new CollectionFactory(inflection.singularize(name), selector, polymorphicKey, this)
}
...
TemplateFactory.prototype.parse = function() {
  ...
  this.parser.on("reaction", function(el, reaction) {
    _(stack).last().mapReaction(el, reaction)
  })
