...
TemplateFactory.prototype.parse = function() {
  ...
  this.parser = new Parser(this.markup, { templates: templateRegistry, rootTemplate: this.name })
...
TemplateMethods.bindTo = function(name, presenter) {
  var that = this
