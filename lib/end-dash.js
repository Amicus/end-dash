...
EndDash.registerTemplate = Parser.load;
EndDash.getTemplateClass = _.bind(Parser.getTemplateClass, Parser);
...
EndDash.compile = function(module, filename) {
  ...
  module.exports = Parser.loadAndParse(templateName, markup);
};
