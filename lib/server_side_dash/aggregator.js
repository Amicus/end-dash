...
var EndDashFileAgreggator = module.exports = function(opts) { //Account for leading / or not
  this.templateDir = this.pwd = opts.templateDir || "templates/"
  this.aggregatedFilesDir = opts.serveRoot || __dirname
  this.files = files
}

EndDashFileAgreggator.prototype.loadFiles = function() {
...
EndDashFileAgreggator.prototype.deleteOldFile = function() {
  var path = this.aggregatedFilesDir + "/EndDashTemplates.js"
  if(fs.existsSync(path)){
    fs.unlinkSync(path, function(err){
      throw new Error("Problem deleting the old EndDashTemplates file in" + this.aggregatedFilesDir )
    })
  }
}

EndDashFileAgreggator.prototype.writeFiles = function() {
  ...
  _.each(Object.keys(files), function(fileName){
    ...
    fs.writeSync(fd, "<script type='EndDash' name='" + templateName + "' >\n")
...
EndDashFileAgreggator.prototype.parseDirectory = function(fileNames) { //Consider sym links and other odd cases
  var that = this
...
EndDashFileAgreggator.prototype.handleFile = function(fileName) {
...
EndDashAgreggator.prototype.handleDirectory = function(nextDirName) {
